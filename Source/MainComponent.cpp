...
MainComponent::MainComponent()
{
    ...
    playLabel.setColour(Label::backgroundColourId, Colours::black);
    playLabel.setColour(Label::textColourId, Colours::white);
...
void MainComponent::resized()
{
    ...
    playLabel.setBounds(0, getHeight() / 5, getWidth(), getHeight() / 5);

}

void MainComponent::buttonClicked(Button* button)
{
    if (button == &playButton)                                                      // [3]
    {
        ...
        playLabel.setText(currentTimeString, dontSendNotification);                        // [6]
    }
}
